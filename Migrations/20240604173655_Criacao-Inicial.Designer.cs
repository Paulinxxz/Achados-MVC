...
namespace AchadosApi.Migrations
{
    ...
    [Migration("20240604173655_Criacao-Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AchadosApi.Models.Animais", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AchadosApi.Models.Observacoes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AchadosApi.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AchadosApi.Models.Animais", b =>
                {
                    b.HasOne("AchadosApi.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("AchadosApi.Models.Observacoes", b =>
                {
                    b.HasOne("AchadosApi.Models.Animais", "Animais")
                        .WithMany()
